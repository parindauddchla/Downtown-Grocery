...
<html lang="en">
    <head>
        ...
        <title>Cart | Downtown Grocery</title>
                    ...
                    <table class="table table-striped">
                        ...
                        if (mysqli_num_rows($result) >= 1) {
                            ...
                            <tbody>
                                ...
                                $id = rtrim($id, ", ");
                                echo "<tr><td></td><td>Total</td><td>Rs " . $sum . "</td><td><a href='success.php?itemsid=" . $id . "' class='btn btn-primary'>Confirm</a></td></tr>";
                                ?>
                            </tbody>
                            <?php
                        } else {
                            echo "Add items to the cart and then proceed ";
                        }
                        ?>
                        <?php
                        ?>
